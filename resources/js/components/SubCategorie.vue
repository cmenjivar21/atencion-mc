          ...
          <v-container>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="6">
                <base-select-search
                  label="Categoría"
                  v-model.trim="$v.editedItem.name_cat.$model"
                  :items="categorie"
                  item="name_cat"
                  :validation="$v.editedItem.name_cat"
                  :validationsInput="{
                    required: true,
                    minLength: true,
                  }"
              ...
              <v-col cols="12" sm="12" md="6">
                <base-input
                  label="Sub Categoria"
                  v-model="$v.editedItem.name_sub_cat.$model"
...
import categorieApi from "../apis/categorieApi";
...
export default {
  data() {
    return {
      ...
      dialogDelete: false,
      headers: [
        { text: "Sub Categoria", value: "name_sub_cat" },
  ...
  methods: {
    async initialize() {
      ...
      if (responses) {
        this.categorie = responses[1].data.records;
      }
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        const { data } = await subCategorieApi
